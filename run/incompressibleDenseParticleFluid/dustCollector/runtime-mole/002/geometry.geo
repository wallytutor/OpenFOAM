...
pars[] = {D-0.5*(2.808+3.161), hl+0.5*(0.654+1.075), 0.01, 0.550, 45.0};
Call AddInternalFlap;

pars[] = {D-0.5*(1.882+2.373), hl+0.5*(0.000+0.546), 0.01, 0.730, 50.0};
Call AddInternalFlap;

pars[] = {D-0.5*(0.705+1.225), hl+0.5*(0.141+0.441), 0.01, 0.600, 30.0};
Call AddInternalFlap;
